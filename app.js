...
function renderSpeakHome(){
  return '<div style="font-size:0.75rem;color:var(--text3);margin-bottom:10px">AQA French Paper 2 Speaking — Timed exam simulation</div>'
    ...
    + '</div>'
    + '<div style="font-size:0.6rem;text-transform:uppercase;letter-spacing:0.1em;color:var(--text3);font-weight:600;margin-bottom:4px">Exam Structure</div>'
    + '<div style="font-size:0.75rem;color:var(--text2);line-height:1.7;margin-bottom:8px">→ Stimulus card in English — 5 tasks to complete<br>→ Stimulus card includes one unprepared (?) question — you must ask a question<br>→ 1–1.5 minutes total speaking time</div>'
    + '<div style="font-size:0.6rem;text-transform:uppercase;letter-spacing:0.1em;color:var(--text3);font-weight:600;margin-bottom:4px;margin-top:8px">Exam Tips</div>'
    + '<div style="font-size:0.75rem;color:var(--text2);line-height:1.7">→ Read each bullet carefully — look out for the tense e.g. past tense<br>→ Give only the number of details asked — give two details unless told otherwise<br>→ Keep answers short and accurate — longer answers risk extra mistakes<br>→ Prepare the ? task carefully — it\'s an easy mark to bank</div>'
    + '</div>'
    ...
    + '</div>'
    + '<div style="font-size:0.6rem;text-transform:uppercase;letter-spacing:0.1em;color:var(--text3);font-weight:600;margin-bottom:4px">Exam Structure</div>'
    + '<div style="font-size:0.75rem;color:var(--text2);line-height:1.7;margin-bottom:8px">→ Short French text (~50 words) — read aloud when teacher asks<br>→ You are NOT allowed to read aloud during prep — practise silently<br>→ Teacher then asks 4 pre-set questions on the topic<br>→ Marked as a whole — clarity and confidence count most</div>'
    + '<div style="font-size:0.6rem;text-transform:uppercase;letter-spacing:0.1em;color:var(--text3);font-weight:600;margin-bottom:4px;margin-top:8px">Exam Tips</div>'
    + '<div style="font-size:0.75rem;color:var(--text2);line-height:1.7">→ Practise in your head at least twice during prep time<br>→ Underline tricky pronunciations and liaisons before you start<br>→ Keep it slow and clear — do not panic, you can repeat what you said<br>→ Use <strong style="color:var(--green);cursor:pointer;text-decoration:underline dotted" onclick="toggleSpeakTips();setTipTab('sore')">SORE</strong> to structure each answer — tap to open phrase guide</div>'
    + '</div>'

    // Part 3 — Photo Card
    + '<div style="border-left:3px solid var(--gold);padding:10px 14px;margin-bottom:10px;background:rgba(227,179,65,0.04);border-radius:0 var(--radius-sm) var(--radius-sm) 0">'
    + '<div style="display:flex;justify-content:flex-start;align-items:center;gap:12px;margin-bottom:8px">'
    ...
    + '</div>'
    + '<div style="font-size:0.6rem;text-transform:uppercase;letter-spacing:0.1em;color:var(--text3);font-weight:600;margin-bottom:4px">Exam Structure</div>'
    + '<div style="font-size:0.75rem;color:var(--text2);line-height:1.7;margin-bottom:8px">→ Two photos from one AQA theme — describe both, then conversation<br>→ ~1.5 mins photo description, then ~4–5 mins unprepared conversation<br>→ Written notes are allowed during both prep and the test</div>'
    + '<div style="font-size:0.6rem;text-transform:uppercase;letter-spacing:0.1em;color:var(--text3);font-weight:600;margin-bottom:4px;margin-top:8px">Exam Tips</div>'
    + '<div style="font-size:0.75rem;color:var(--text2);line-height:1.7">→ Use <strong style="color:var(--gold);cursor:pointer;text-decoration:underline dotted" onclick="toggleSpeakTips();setTipTab('spalma')">SPALMA</strong> to structure your photo description — tap to open phrase guide<br>→ Write useful expressions and varied vocab during prep time<br>→ Describe only what you can see — avoid drifting into personal stories<br>→ Listen for the tense in teacher questions and match it in your answer<br>→ Show variety — synonyms, different expressions, varied tenses</div>'
    + '</div>'
...
function toggleSpeakTips(){
  ...
  if(ov.style.display === 'none'){
    ...
    var defaultTab = speakPart === 'ra' ? 'sore' : 'spalma';
...
function setTipTab(tab){
  ['Spalma','Sore'].forEach(function(t){
...
function renderTipsOverlay(){
  ...
  var spalmaData = [
    {l:'S',w:'Start',d:'Introduce what you see',col:'#E6F1FB',txt:'#0C447C',
     ex:'Je vois... / On voit... / Il y a...\nEn regardant les photos, je vois...\nD\'abord, sur la première photo...\nAu premier plan... / En arrière-plan...'},
    {l:'P',w:'People',d:'Who is in the photo',col:'#EEEDFE',txt:'#3C3489',
     ex:'Un homme / une femme / un jeune / une fille\nDes élèves / une famille / un groupe de personnes\nIl y a aussi... / On peut voir...'},
    {l:'A',w:'Action',d:'What they are doing',col:'#EAF3DE',txt:'#27500A',
     ex:'Ils mangent / parlent / sourient / jouent\nIls sont en train de... (manger, discuter...)\nIl semble que... / On dirait qu\'ils...'},
    {l:'L',w:'Location',d:'Where the photo is set',col:'#FAEEDA',txt:'#633806',
     ex:'À l\'école / dans la rue / à la montagne\nAu bord de la mer / en ville / à la maison\nLa scène se passe... / Ça se passe...'},
    {l:'M',w:'Mood',d:'How people look or feel',col:'#FAECE7',txt:'#712B13',
     ex:'Ils ont l\'air... / Il semble... / On dirait qu\'ils sont...\ncontent(e) / heureux(se) / détendu(e) / fatigué(e)\nL\'ambiance est... / L\'atmosphère semble...'},
    {l:'A',w:'Add details',d:'Weather, background or extra observations',col:'#E1F5EE',txt:'#085041',
     ex:'Il y a du soleil / du vent / des nuages\nIl fait beau / mauvais / chaud / froid\nOn remarque aussi... / De plus, on peut voir...'},
  ];

  // SORE panel
  var soreData = [
    {l:'S',w:'Statement',d:'Direct answer to the question',col:'#E6F1FB',txt:'#0C447C',
     ex:'Je pense que... / Je crois que... / À mon avis...\nJ\'habite... / Je fais... / Je joue... / Je mange...'},
    {l:'O',w:'Opinion',d:'What you think or feel',col:'#EEEDFE',txt:'#3C3489',
     ex:'Je l\'adore / Je l\'apprécie / J\'aime beaucoup\nJe trouve que... / Il me semble que... / C\'est + adj\nC\'est génial / formidable / nul / ennuyeux'},
    {l:'R',w:'Reason',d:'Explain why',col:'#EAF3DE',txt:'#27500A',
     ex:'parce que... / car... / puisque...\nça m\'aide à... / ça me permet de...\npar exemple... / surtout quand...'},
    {l:'E',w:'Extend',d:'Add a 3rd clause for top marks',col:'#FAEEDA',txt:'#633806',
     ex:'À l\'avenir, je voudrais... / j\'espère...\nLa semaine dernière, j\'ai... / Hier, j\'ai...\nNormalement... / D\'habitude... / Cependant...'},
  ];

  function renderLetters(data){
    return data.map(function(d){
      var phrases = d.ex.split('\n').filter(function(p){ return p.trim(); });
      var chipsHtml = phrases.map(function(p){
        return '<span class="speak-letter-chip" style="border-color:'+d.col+';color:'+d.txt+'">'+p.trim()+'</span>';
      }).join('');
      return '<div class="speak-letter-card">'
        + '<div class="speak-letter-left">'
        + '<div class="speak-letter-badge" style="background:'+d.col+';color:'+d.txt+'">'+d.l+'</div>'
        + '<div class="speak-letter-word">'+d.w+'</div>'
        + '<div class="speak-letter-desc">'+d.d+'</div>'
        + '</div>'
        + '<div class="speak-letter-right">'+chipsHtml+'</div>'
        + '</div>';
    }).join('');
  }
  ...
  if(sp) sp.innerHTML = '<div style="font-size:0.75rem;color:var(--text2);line-height:1.5;margin-bottom:12px">Use the <strong>SPALMA</strong> structure to guide your description of the photo cards. Work through each letter — it keeps your answer organised and earns more marks.</div>' + renderLetters(spalmaData);
  if(so) so.innerHTML = '<div style="font-size:0.75rem;color:var(--text2);line-height:1.5;margin-bottom:12px">Use the <strong>SORE</strong> structure to guide your responses during teacher conversations. Aim to hit all four elements for the highest marks.</div>' + renderLetters(soreData)
    + '<div style="margin-top:10px;padding:8px 12px;border-radius:6px;background:rgba(248,81,73,0.08);font-size:0.72rem;color:var(--red)">⚠️ Role Play only: keep answers short and accurate — longer answers risk extra mistakes!</div>'
}

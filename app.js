...
function openMenu(){
  ...
  // Show admin button only for CD Admin9
  var adminBtn = document.getElementById('menuAdminBtn');
  if(adminBtn) adminBtn.style.display = currentProfile.name === 'CD Admin9' ? '' : 'none';
  buildFilterChips();
  updateMenuStats();
  updateSettingsSummary();
  updateDailyGoalUI();

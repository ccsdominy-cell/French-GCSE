...
function renderSpeakHome(){
  return '<div style="font-size:0.75rem;color:var(--text3);margin-bottom:10px">AQA French Paper 2 Speaking — Timed exam simulation</div>'
    ...
    + '<div style="font-size:0.6rem;text-transform:uppercase;letter-spacing:0.1em;color:var(--text3);font-weight:600;margin-bottom:4px;margin-top:8px">Exam Tips</div>'
    + '<div style="font-size:0.75rem;color:var(--text2);line-height:1.7">→ Use <strong style="color:var(--gold)">SPALMA</strong> to structure your photo description — see the Tips button above<br>→ Write useful expressions and varied vocab during prep time<br>→ Describe only what you can see — avoid drifting into personal stories<br>→ Listen for the tense in teacher questions and match it in your answer<br>→ Show variety — synonyms, different expressions, varied tenses</div>'
    + '</div>'

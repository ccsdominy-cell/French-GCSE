...
function startStudy(mode){
  ...
  badge.textContent=mode==='hard'?'💪 Your Hard Words':isFaux?'🪤 Faux Amis':'🃏 Flashcards';
...
function showResults(){
  ...
  const modeLabel = currentMode==='hard'?'Your Hard Words':currentMode==='faux'?'Faux Amis':'Flashcards';
...
function getFeedbackPageContext(){
  ...
  const modeLabels = {
    ...
    synScreen: 'Key Synonyms',
    timeScreen: 'Useful Time Expressions',
